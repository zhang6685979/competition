  ...
  <el-dialog
    ...
    <el-form :model="inputForm" size="small" ref="inputForm" v-loading="loading" :class="method==='view'?'readonly':''"  :disabled="method==='view'"
      ...
      <el-row  :gutter="15">
        ...
        <el-col :span="12">
            <el-form-item label="单位名称" prop="school"
                :rules="[
                 ]">
              <el-input v-model="inputForm.school" placeholder="请填写单位名称"     ></el-input>
           </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      init (method, id) {
        ...
        this.$nextTick(() => {
          ...
          if (method === 'edit' || method === 'view') { // 修改或者查看
            this.loading = true
            this.playerService.queryById(this.inputForm.id).then(({data}) => {
