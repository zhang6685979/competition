<template>
  <div class="page">
      ...
      <vxe-toolbar :refresh="{query: refreshList}">
        <template #buttons>
          ...
          <el-button type="warning" size="small" icon="el-icon-edit-outline" @click="edit()"
            :disabled="$refs.competitionSignupTable && $refs.competitionSignupTable.getCheckboxRecords().length !== 1"
            plain>修改</el-button>
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <CompetitionSignupForm ref="competitionSignupForm" :cid="id" @refreshDataList="refreshList"></CompetitionSignupForm>
    ...
    methods: {
      ...
      del(id) {
        ...
        this.$confirm(`确定删除所选项吗?`, '提示', {
          ...
          this.loading = true
          this.competitionSignupService.delete(ids).then(({
            data
          }) => {
