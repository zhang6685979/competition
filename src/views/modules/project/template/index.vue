  ...
  <div class="create-container">
    <div>
      <div class="create-header-container">
        <div class="filter-container query-form">
      ...
      <div class="project-grid-container bg-white">
        <el-menu :default-active="queryParams.type" mode="horizontal" style="background-color: transparent" @select="
                        index => {
    ...
    <div class="text-center">
      <el-pagination v-if="total > 10" :current-page.sync="queryParams.current" :page-size.sync="queryParams.size"
        :total="total" background layout="total, prev, pager, next" @current-change="queryTemplatePage" />
    </div>
  </div>
</template>
