            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="4" v-for="(item, index) in projectList" :key="index">
              <el-card style="margin: 8px" :body-style="{ padding: '0px' }" shadow="always">
                ...
                <div class="jp-card-label">
                  <p>{{item.name}}</p> <el-tag size="small" :type="getStatusColorStyle(item.status).type">{{getStatusColorStyle(item.status).name}}</el-tag>
                </div>
                <ul class="jp-card-actions">
                  ...
                  <li v-if="item.status!=1">
                    <el-link :underline="false" @click="toProjectHandle(item.key,'statistics')"><i class="el-icon-delete"></i> 统计</el-link>
                  </li>
                  <li v-if="item.status==2">
                    <el-link :underline="false" @click="stopProject(item.key)"><i class="el-icon-delete"></i> 停止</el-link>
                  </li>
                  <li v-if="item.status!=2">
                    <el-link :underline="false" @click="deleteProject(item.key)"><i class="el-icon-delete"></i> 删除</el-link>
                  </li>
                </ul>
              </el-card>
            </el-col>
