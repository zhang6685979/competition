<template>
  ...
  >
    ...
    >
      <el-button v-if="ui == 'element'" type="primary" :disabled="disabled" @click="handleAdd">{{$t('fm.actions.upload')}}</el-button>
      <a-button v-if="ui == 'antd'" icon="upload" :disabled="disabled" @click="handleAdd">{{$t('fm.actions.upload')}}</a-button>
