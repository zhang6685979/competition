...
<style scoped="">
  ...
  .header .nav-warp{flex:1;}
  .header .nav-warp .nav{max-width: 800px;margin: auto;}
  .header .nav-warp .nav li{
    float:left;
    list-style: none;
  }
  .header .nav-warp .nav li a{display: block;padding:0 20px;line-height: 90px;color:#555;text-decoration: none;font-size:16px;}
  .header .nav-warp .nav li.active a,.header .nav-warp .nav li a:hover{color:#e91b23!important;}
  .siteNav{
    margin-left: 5px;
    display: table-cell;
  ...
  .header.black{background: rgba(0,0,0,.4)!important;}
