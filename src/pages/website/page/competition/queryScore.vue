<template>
  <div>
     <el-form :model="inputForm" size="small" ref="inputForm" v-loading="loading" class="el-form" label-width="150px" v-if="!resultVisible">
...
<style lang="scss" scoped>
  ...
  .result-list{
    ...
    margin: 0 auto;
    padding: 100px 0;
    p{text-align: left;margin-bottom: 35px;span{margin-right:100px;font-size: 18px;}}
    table{
      width: 100%;
      margin: 0 auto;
      border-spacing: 0;
      tr{
        &:first-child{background-color: #F5F5F5;font-size:18px;}
        &:last-child{color: #DC000C;font-size: 32px;}
        td{
          height:60px;
